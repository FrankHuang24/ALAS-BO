...
# rbf_covariance and matern52_covariance are defined here for sampling the true function
...
def train_model(train_X, train_Y, kernel_type, maxiter: int = 300):
    ...
    if kernel_type == "rbf":
        ...
        with torch.no_grad():
            # intialize alpha to 1.5, test if it can recover 2.0
